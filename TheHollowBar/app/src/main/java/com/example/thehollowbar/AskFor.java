...
public class AskFor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgFlyingProduct = findViewById(R.id.imgFlyingObject); // Asegúrate de que este ID coincida
    ...
    private void animateProductToCart() {
        ...
        float deltaX = cartLocation[0] - imgFlyingProduct.getWidth() / 2;
        float deltaY = cartLocation[1] - imgFlyingProduct.getHeight() / 2;
